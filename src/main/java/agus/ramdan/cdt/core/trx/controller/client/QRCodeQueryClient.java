...
@FeignClient(name = "feign-client.api-cdt-core-trx-query-service.qr-code", url = "${feign-client.api-cdt-core-trx-query-service.base-url}/api/cdt/core/trx/qr-code/query")
