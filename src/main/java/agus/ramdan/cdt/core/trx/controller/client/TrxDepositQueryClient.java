...
@FeignClient(name = "feign-client.api-cdt-core-trx-query-service.deposit", url = "${feign-client.api-cdt-core-trx-query-service.base-url}/api/cdt/core/trx/deposit/query")
