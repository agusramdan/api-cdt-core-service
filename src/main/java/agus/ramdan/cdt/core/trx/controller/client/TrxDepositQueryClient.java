...
@FeignClient(name = "feign-client.api-cdm-core-trx-query-service.qr-code", url = "${feign-client.api-cdm-core-trx-query-service.base-url}/api/cdt/core/trx/deposit/query")
