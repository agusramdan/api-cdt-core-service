...
@FeignClient(name = "feign-client.api-cdt-core-trx-query-service.pickup", url = "${feign-client.api-cdt-core-trx-query-service.base-url}/api/cdt/core/trx/pickup/query")
